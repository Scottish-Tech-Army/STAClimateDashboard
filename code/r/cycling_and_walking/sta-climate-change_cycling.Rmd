...
load("cycling_datasets.Rdata")  #interim
...
### Cycle Counts - tracked across 63 counters in Scotland Jun 2017 to Jun 2021

![](wip.png "Icon obtained from Icon Fonts - http://www.onlinewebfonts.com/icon, CC BY 3.0 license"){width=50%}
...
### Bicycle &amp; Pedestrian Counts {data-height=600}

####
```{r, bicycle_counts, fig.height = 4, fig.width = 10}
```

####
```{r, pedestrian_counts, fig.height = 1.5}
```


### Counter Locations

```{r, counter_installation_data, fig.height = 8, fig.width = 12}
```
...
```{r, counts_time_of_day_by_month_and_year}
```
