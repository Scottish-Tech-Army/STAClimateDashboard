...
knitr::opts_chunk$set(out.width = '100%', out.height = '100%', fig.align = 'left',
                      echo = FALSE, warning = FALSE, message = FALSE, cache.lazy = FALSE)
...
```{=html}
<p>&nbsp;<br />
Focusing on the NMF counters, at end `r format(end_date, "%b %Y") ` over <b>5m bikes</b> and <b>21m pedestrians</b> had been recorded going past all counters.
