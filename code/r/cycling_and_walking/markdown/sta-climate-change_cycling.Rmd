...
<p>
The data now also includes council-managed counters, Sustrans counters on the Natioanal Cycle NETWORK (NCN) and along key points on trunk roads. Five counters along the John Muir Way, located around the west, central belt are also included in the data reported.
